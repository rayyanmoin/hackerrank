...
Function Description: Complete the aVeryBigSum function in the editor below. It
...
might exceed the above range. You might need to use long int C/C++/Java to store
such sums.
 */
const input = `5
